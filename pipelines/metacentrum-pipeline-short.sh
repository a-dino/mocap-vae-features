...
REPO_DIR='/storage/brno12-cerit/home/abecvarov/experiments'
ENV_NAME='cuda4'
...
#    train_split=${REPO_DIR}/mocap-vae-features/pipelines/data/splits/CS_train_objects_messif-lines.txt > /dev/null 2>&1

#python ${REPO_DIR}/mocap-vae-features/train.py --multirun exp=pku-mmd/cv \
#    latent_dim=${DIM} beta=${BETA} iteration=${ITER} body_model=pku-mmd \
#    train_split=${REPO_DIR}/mocap-vae-features/pipelines/data/splits/CV_train_objects_messif-lines.txt > /dev/null 2>&1
...
-k 4 \
--scl \
-dd ${REPO_DIR}/mocap-vae-features/pipelines/data/description/hdm05/category_description.txt \
"
...
#-k 18 \
#--scl \
#-dd ${REPO_DIR}/mocap-vae-features/pipelines/data/description/pku-mmd/category_description.txt \
#"
#echo "${COMMAND}"
